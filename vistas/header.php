...
<html lang="en">
    ...
    <head>
        ...
        <!-- color CSS -->
        <link href="../ampleadmin-minimal/css/colors/green-dark.css" id="theme" rel="stylesheet">
                    ...
                    <ul class="nav navbar-top-links navbar-right pull-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-user animated flipInY">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="../ajax/usuario.php?op=salir"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <!-- /.dropdown -->
