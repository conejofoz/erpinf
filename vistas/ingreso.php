                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <select id="idproveedor" name="idproveedor" class="form-control select-picker" data-live-search="true" required>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="tipo_comprovante" name="tipo_comprovante" class="form-control select-picker" data-live-search="true" required>
                           ...
                           <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                            <label>Serie:</label>
                            <input type="text" class="form-control" name="serie_comprovante" id="serie_comprovante" maxlength="7" placeholder="Serie" required>
                          </div> 
                            
                           <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                            <label>Numero:</label>
                            <input type="text" class="form-control" name="num_comprovante" id="num_comprovante" maxlength="10" placeholder="Numero" required>
                          </div> 
                           ...
                           <div class="table-responsive col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                               <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                                   ...
                                   <tfoot>
                                      ...
                                      <th></th> 
                                      <th></th> 
                                      <th><h4 id="total">S/. 000</h4><input type="hidden" name="total_compra" id="total_compra"></th> 
                                   </tfoot>
                                   <tbody>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title">Selecione un articulo</h4>
              </div>
